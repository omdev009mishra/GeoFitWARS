...
const RetroEffect = forwardRef<RetroEffectImpl, { colorNum: number; pixelSize: number }>(function RetroEffect(
  { colorNum, pixelSize },
  ref,
) {
...
function DitheredWaves({
  ...
  useFrame(({ clock }) => {
    ...
    if (uniforms.waveFrequency.value !== waveFrequency) uniforms.waveFrequency.value = waveFrequency
    if (uniforms.waveAmplitude.value !== waveAmplitude) uniforms.waveAmplitude.value = waveAmplitude
